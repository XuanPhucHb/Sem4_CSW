 ...
 * 
 */
@WebServiceClient(name = "ProductServiceService", targetNamespace = "http://service.csw_compe.nxp.com/", wsdlLocation = "http://localhost:8081/ws/product?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICESERVICE_QNAME = new QName("http://service.csw_compe.nxp.com/", "ProductServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/ws/product?wsdl");
    ...
    public ProductService getProductServicePort() {
        return super.getPort(new QName("http://service.csw_compe.nxp.com/", "ProductServicePort"), ProductService.class);
    }
    ...
    public ProductService getProductServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.csw_compe.nxp.com/", "ProductServicePort"), ProductService.class, features);
    }
